...
`resqmesh_app/`. This repo-root file is the canonical governance entrypoint —
`resqmesh_app/CLAUDE.md` only points back here.

Paths in the rules below are relative to `resqmesh_app/` (the Flutter project
