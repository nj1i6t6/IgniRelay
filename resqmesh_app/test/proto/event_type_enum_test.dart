...
void main() {
  group('EventType enum — Bug 1 regression', () {
    ...
    test('values list contains all 14 entries', () {
      expect(EventType.values.length, equals(14));
    });

    test('valueOf(14) returns null (out of range)', () {
      expect(EventType.valueOf(14), isNull);
    });
  });
}
