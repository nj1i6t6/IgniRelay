...
class EventType extends $pb.ProtobufEnum {
  ...
  static const EventType HAZARD_CONFIRM = EventType._(14, _omitEnumNames ? '' : 'HAZARD_CONFIRM');
  static const EventType MATCH_LOCATION_UPDATE = EventType._(15, _omitEnumNames ? '' : 'MATCH_LOCATION_UPDATE');
